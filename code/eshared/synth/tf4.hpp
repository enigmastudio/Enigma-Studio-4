...
const eU32 TF_MAXFRAMESIZE          = 1024;
...
enum eTfParam
{
    ...
    TF_GEN_SPREAD,
    TF_GEN_SCALE,
    TF_GEN_RANDOM,  // not used anymore
    TF_GEN_SUBOSC,  // not used anymore
    TF_GEN_SHAPE,   // not used anymore
    TF_GEN_TEST,    // not used anymore
...
void    eTfGeneratorFft(eTfSynth &synth, eTfFftType type, eF32 *buffer);
